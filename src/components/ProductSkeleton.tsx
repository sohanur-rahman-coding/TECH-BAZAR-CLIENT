...
export default function ProductSkeleton() {
  return (
    <div className="flex flex-col h-full bg-slate-900/20 border border-slate-800/80 rounded-2xl overflow-hidden animate-pulse">
      {/* Image Skeleton */}
      <div className="relative aspect-video w-full bg-slate-950/80 border-b border-slate-800" />
      ...
      <div className="flex flex-col flex-grow p-5 space-y-4">
        ...
        <div className="flex justify-between items-center pt-2 mt-auto">
          <div className="space-y-1">
            <div className="h-2 w-8 bg-slate-800/40 rounded" />
